 ...
 */
public class LaziestPersonInMusicFragment extends Fragment {
    ...
    DatabaseReference categorie = database.getReference("Categories").child("Laziest Person in Music").child("Nominees");

    ArrayList<TopThreeListModel> topThreeListModelArrayList = new ArrayList<>();


    public LaziestPersonInMusicFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_laziest_person_in_music, container, false);
