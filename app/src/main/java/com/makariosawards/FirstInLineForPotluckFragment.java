 ...
 */
public class FirstInLineForPotluckFragment extends Fragment {
    ...
    DatabaseReference categorie = database.getReference("Categories").child("First in Line for Potluck").child("Nominees");

    ArrayList<TopThreeListModel> topThreeListModelArrayList = new ArrayList<>();


    public FirstInLineForPotluckFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_first_in_line_for_potluck, container, false);
