 ...
 */
public class QuietestFragment extends Fragment {
    ...
    DatabaseReference categorie = database.getReference("Categories").child("Quietest").child("Nominees");

    ArrayList<TopThreeListModel> topThreeListModelArrayList = new ArrayList<>();


    public QuietestFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_quietest, container, false);
