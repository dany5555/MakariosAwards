 ...
 */
public class MostDramaticFragment extends Fragment {
    ...
    DatabaseReference categorie = database.getReference("Categories").child("Most Dramatic").child("Nominees");

    ArrayList<TopThreeListModel> topThreeListModelArrayList = new ArrayList<>();


    public MostDramaticFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_most_dramatic, container, false);
