 ...
 */
public class MostPassionateFragment extends Fragment {
    ...
    DatabaseReference categorie = database.getReference("Categories").child("Most Passionate").child("Nominees");

    ArrayList<TopThreeListModel> topThreeListModelArrayList = new ArrayList<>();


    public MostPassionateFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_most_passionate, container, false);
