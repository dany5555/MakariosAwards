 ...
 */
public class BestDirectivaMemberFragment extends Fragment {
    ...
    DatabaseReference categorie = database.getReference("Categories").child("Best Directiva Member").child("Nominees");

    ArrayList<TopThreeListModel> topThreeListModelArrayList = new ArrayList<>();



    public BestDirectivaMemberFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_best_directiva_member, container, false);
