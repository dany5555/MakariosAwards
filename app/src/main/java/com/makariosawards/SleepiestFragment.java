 ...
 */
public class SleepiestFragment extends Fragment {
    ...
    DatabaseReference categorie = database.getReference("Categories").child("Sleepiest").child("Nominees");

    ArrayList<TopThreeListModel> topThreeListModelArrayList = new ArrayList<>();


    public SleepiestFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_sleepiest, container, false);
